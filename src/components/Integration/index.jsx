    ...
    const socialPlatforms = [
        {
            ...
            link: "https://open.spotify.com/artist/1gYdjzLQVIKiyEzE1Ku5MQ",
        },
        {
            name: "YouTube",
            icon: (
            ...
            link: "https://preview.wolfthemes.store/herion/landing/#",
        },
        {
            name: "Instagram",
            icon: (
        ...
        },
        {
            ...
            link: "https://www.facebook.com/wolfthemes",
        },
        {
            name: "More",
            icon: (
                ...
                <div className="social-icons">
                    {socialPlatforms.map((platform, index) => (
                        <div
                            ...
                            onClick={() => handleBlank(platform.link)}
                        >
                            {platform.icon}
                        </div>
                    ))}
